...
> Acredito que **tecnologia é ferramenta para resolver problemas reais**. Meus projetos de software sempre buscam entregar valor prático e utilitário alinhado ao usuário ou eu mesmo.

### 💻 Stack Técnico
- **Linguagens**: Python, JavaScript
- **Frameworks**: Django, FastAPI ,React, Next.js,
- **Bancos de Dados**: PostgreSQL, Oracle
- **DevOps**: Docker, CI/CD (GitHub Actions), Kubernetes, Terraform
